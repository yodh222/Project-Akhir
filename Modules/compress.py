...
class Compress(ctk.CTkFrame):
    ...
    def browse_source(self):
        """Select file or folder based on switch selection."""
    ...
    def compress_folder(self, source, output):
        """Create TAR from folder → then compress to TAR.GZ"""
