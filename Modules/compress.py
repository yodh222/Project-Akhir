...
class Compress(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        ctk.CTkButton(self, text="Start Compression", width=160, command=self.start_compression).grid(
    ...
    def browse_source(self):
        path = filedialog.askopenfilename() if self.combo_switch.get() == "File" else filedialog.askdirectory()
        if path:
    ...
    def show_wait_popup(self):
        ...
        ctk.CTkLabel(self.popup, text="Compressing...\nPlease wait.", font=("Arial", 16)).pack(pady=20)
    ...
    def compress_folder(self, source, output):
        ...
        LogCreate("CompressModule", f"Folder compression completed: {gz_path}", level=SUCCESS)
    ...
    def compress_process(self):
        ...
        LogCreate("CompressModule", f"Compression started. Mode={mode}, Source={source}, Output={output}")
        ...
        try:
            ...
            LogCreate("CompressModule", "Compression finished successfully", level="SUCCESS")
